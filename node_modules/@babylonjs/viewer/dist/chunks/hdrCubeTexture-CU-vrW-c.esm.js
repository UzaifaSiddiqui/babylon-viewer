import { C as Constants, I as ILog2, V as Vector3, E as EffectWrapper, a as EffectRenderer, B as BaseTexture, M as Matrix, O as Observable, T as Texture, b as Tools, c as CubeMapToSphericalPolynomialTools, d as ToGammaSpace, e as ToHalfFloat, R as RegisterClass } from './index-D3asnK0t.esm.js';
import { G as GetCubeMapTextureData } from './hdr-ClICO_6D.esm.js';
import { I as IblCdfGenerator } from './iblCdfGenerator-D_Hr-WHs.esm.js';
    ...
    _createEffect(texture, onCompiled) {
        ...
        const effectWrapper = new EffectWrapper({
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./hdrFiltering.vertex-T14ZpZ7x.esm.js'), import('./hdrFiltering.fragment-ClpLILO0.esm.js')]);
                }
                else {
                    await Promise.all([import('./hdrFiltering.vertex-Cgn8kwnj.esm.js'), import('./hdrFiltering.fragment-dUYrDIEq.esm.js')]);
                }
            },
        });
...
class HDRIrradianceFiltering {
    ...
    _createEffect(texture, onCompiled) {
        ...
        const effectWrapper = new EffectWrapper({
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([import('./hdrIrradianceFiltering.vertex-IW0w4cca.esm.js'), import('./hdrIrradianceFiltering.fragment-DeXpZJKL.esm.js')]);
                }
                else {
                    await Promise.all([import('./hdrIrradianceFiltering.vertex-ByoXGzsC.esm.js'), import('./hdrIrradianceFiltering.fragment-Crj8QDJ8.esm.js')]);
                }
            },
        });
        return effectWrapper;
...
//# sourceMappingURL=hdrCubeTexture-CU-vrW-c.esm.js.map
