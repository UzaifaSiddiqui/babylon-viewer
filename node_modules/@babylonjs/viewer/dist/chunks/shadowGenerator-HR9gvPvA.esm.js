import { E as EffectWrapper, k as Engine, P as PostProcess, T as Texture, C as Constants, X as SerializationHelper, u as __decorate, a4 as serializeAsVector2, v as serialize, R as RegisterClass, O as Observable, V as Vector3, M as Matrix, h as RenderTargetTexture, j as Color4, a5 as RenderingManager, a6 as Vector2, H as DrawWrapper, a7 as Light, s as BindMorphTargetParameters, r as BindClipPlane, q as BindSceneUniformBuffer, m as VertexBuffer, Z as EffectFallbacks, n as PrepareDefinesAndAttributesForMorphTargets, p as PrepareStringDefinesForClipPlanes, o as PushAttributesForInstances, A as AddClipPlaneUniforms, _ as _WarnImport } from './index-D3asnK0t.esm.js';
...
class ThinBlurPostProcess extends EffectWrapper {
    _gatherImports(useWebGPU, list) {
        if (useWebGPU) {
            ...
            list.push(Promise.all([import('./kernelBlur.fragment-DG2armNs.esm.js'), import('./kernelBlur.vertex-MNtccWms.esm.js')]));
        }
        else {
            list.push(Promise.all([import('./kernelBlur.fragment-XaUtojgT.esm.js'), import('./kernelBlur.vertex-D4UhPnHJ.esm.js')]));
        }
    }
    /**
...
class ShadowGenerator {
    ...
    async _initShaderSourceAsync(forceGLSL = false) {
        ...
        if (engine.isWebGPU && !forceGLSL && !ShadowGenerator.ForceGLSL) {
            ...
            await Promise.all([
                import('./shadowMap.fragment-BvCXV4Rp.esm.js'),
                import('./shadowMap.vertex-1KHSBf10.esm.js'),
                import('./depthBoxBlur.fragment-Uf5C_qzU.esm.js'),
                import('./shadowMapFragmentSoftTransparentShadow-B1CSlClL.esm.js'),
            ]);
        }
        else {
            await Promise.all([
                import('./shadowMap.fragment-H0pvBkk3.esm.js'),
                import('./shadowMap.vertex-CRoJY0wK.esm.js'),
                import('./depthBoxBlur.fragment-D98_GaoI.esm.js'),
                import('./shadowMapFragmentSoftTransparentShadow-DYpEs2MB.esm.js'),
            ]);
        }
...
//# sourceMappingURL=shadowGenerator-HR9gvPvA.esm.js.map
