...
const shader$7 = `vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
// Do not edit.
const name$6 = "imageProcessingDeclaration";
const shader$6 = `#ifdef EXPOSURE
...
// Do not edit.
const name$5 = "lightFragmentDeclaration";
const shader$5 = `#ifdef LIGHT{X}
...
// Do not edit.
const name$4 = "lightUboDeclaration";
const shader$4 = `#ifdef LIGHT{X}
uniform Light{X}
...
// Do not edit.
const name$3 = "ltcHelperFunctions";
const shader$3 = `vec2 LTCUv( const in vec3 N,const in vec3 V,const in float roughness ) {const float LUTSIZE=64.0;const float LUTSCALE=( LUTSIZE-1.0 )/LUTSIZE;const float LUTBIAS=0.5/LUTSIZE;float dotNV=saturate( dot( N,V ) );vec2 uv=vec2( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
// Do not edit.
const name$2 = "shadowsFragmentFunctions";
const shader$2 = `#ifdef SHADOWS
...
// Do not edit.
const name$1 = "imageProcessingFunctions";
const shader$1 = `#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
//# sourceMappingURL=lightFragment-5MQV20Wq.esm.js.map
