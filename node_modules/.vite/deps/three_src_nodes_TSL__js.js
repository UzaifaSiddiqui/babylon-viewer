...
var TextureNode = class extends UniformNode_default {
  ...
  update() {
    ...
    if (matrixUniform !== null)
      matrixUniform.value = texture2.matrix;
...
var Object3D = class _Object3D extends EventDispatcher {
  ...
  toJSON(meta) {
    ...
    if (isRootObject) {
      ...
      if (images.length > 0)
        output2.images = images;
      if (shapes.length > 0)
        output2.shapes = shapes;
      if (skeletons.length > 0)
        output2.skeletons = skeletons;
      if (animations.length > 0)
        output2.animations = animations;
      if (nodes.length > 0)
        output2.nodes = nodes;
    }
...
var RenderTarget = class extends EventDispatcher {
  ...
  _setTextureOptions(options = {}) {
    ...
    if (options.wrapR !== void 0)
      values.wrapR = options.wrapR;
    if (options.magFilter !== void 0)
    ...
    if (options.anisotropy !== void 0)
      values.anisotropy = options.anisotropy;
    if (options.colorSpace !== void 0)
  ...
  setup(builder) {
    ...
    if (object.count > 1) {
      ...
      if (maxLength === 1)
        ...
        max2.set(maxValue.r, maxValue.g, maxValue.b, 1);
      else
