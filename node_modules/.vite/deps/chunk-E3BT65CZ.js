...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRgbdTextureAsync = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGpu) {
        await import("./rgbdDecode.fragment-O2SMMAHB.js");
      } else {
        await import("./rgbdDecode.fragment-X2PKTJTL.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-EJVGJPRH.js");
    } else {
      await import("./rgbdEncode.fragment-CWFXOR2L.js");
    }
...
//# sourceMappingURL=chunk-E3BT65CZ.js.map
