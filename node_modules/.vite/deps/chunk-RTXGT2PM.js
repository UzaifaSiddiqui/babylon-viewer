...
async function _CreateDumpRendererAsync() {
  if (!EnginePromise) {
    EnginePromise = new Promise((resolve, reject) => {
      ...
      import("./thinEngine-3SNXLWIE.js").then(({ ThinEngine: thinEngineClass }) => {
        var _a;
        ...
        import("./pass.fragment-2P3I3S5Z.js").then(({ passPixelShader }) => {
          if (!engine) {
...
//# sourceMappingURL=chunk-RTXGT2PM.js.map
