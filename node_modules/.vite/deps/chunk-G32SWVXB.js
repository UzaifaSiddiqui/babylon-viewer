import {
  EffectWrapper
} from "./chunk-B74HYAR3.js";
import {
  HasStencilAspect,
  ThinEngine,
  WebGLDataBuffer,
  WebGLHardwareTexture
} from "./chunk-VZSJF5KY.js";
import {
  BaseTexture,
  Texture
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-PEMNLYBK.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callbackAsync = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-B4SMWIK7.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-NK4THNTZ.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-2P3I3S5Z.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-7ITZJUCY.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-EQDMPOTY.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-GEZNBCQA.js");
    } else {
      await import("./lod.fragment-PN6F2EL2.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-JIDITHI7.js");
    } else {
      await import("./lod.fragment-YGGODTET.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-G32SWVXB.js.map
