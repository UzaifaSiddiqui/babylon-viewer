...
} from "./chunk-HDKDYI4D.js";
import {
  EffectWrapper
} from "./chunk-U6F2POQ4.js";
import {
  PostProcessManager,
  RenderingManager,
  SmartArray
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-OWEQLRQV.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-Z2C3AWHZ.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-PXDBCIBK.js")]));
    }
  }
  /**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callbackAsync = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-F2N3AUXZ.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-B72HXVJM.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-YZARCOA3.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-5X5LGBCG.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-B6RWJGWV.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-4K44GUZM.js");
    } else {
      await import("./lod.fragment-USMW2ALQ.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-52O4J6HT.js");
    } else {
      await import("./lod.fragment-MUQM4QVI.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-FZ54PSXY.js.map
