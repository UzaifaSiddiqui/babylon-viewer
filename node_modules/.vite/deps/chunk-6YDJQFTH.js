    ...
    if (material) {
      ...
      options.extraInitializationsAsync = async () => {
        if (this._shaderLanguage === 1) {
          await Promise.all([import("./color.vertex-ZPZU7BMP.js"), import("./color.fragment-OKNDXMOF.js")]);
        } else {
          await Promise.all([import("./color.vertex-O6Z3C2RU.js"), import("./color.fragment-PWK6QUY2.js")]);
        }
      };
...
var GreasedLineTools = class _GreasedLineTools {
  ...
  static ConvertPoints(points, options) {
    if (points.length && Array.isArray(points) && typeof points[0] === "number") {
      ...
      if (options == null ? void 0 : options.floatArrayStride) {
        const positions = [];
  ...
  static _SearchInPoints(p1, p2, points) {
    ...
    for (const ps of points) {
      for (let i = 0; i < ps.length; i++) {
        if ((_a = ps[i]) == null ? void 0 : _a.equals(p1)) {
          if (((_b = ps[i + 1]) == null ? void 0 : _b.equals(p2)) || ((_c = ps[i - 1]) == null ? void 0 : _c.equals(p2))) {
            return true;
          }
        }
      }
  ...
  static DisposeEmptyColorsTexture() {
    var _a;
    (_a = GreasedLineMaterialDefaults.EmptyColorsTexture) == null ? void 0 : _a.dispose();
...
var GreasedLinePluginMaterial = class _GreasedLinePluginMaterial extends MaterialPluginBase {
  ...
  constructor(material, scene, options) {
    ...
    this._forceGLSL = (options == null ? void 0 : options.forceGLSL) || _GreasedLinePluginMaterial.ForceGLSL;
  ...
  bindForSubMesh(uniformBuffer) {
    ...
    uniformBuffer.updateFloat2("grl_textureSize", (texture == null ? void 0 : texture.getSize().width) ?? 1, (texture == null ? void 0 : texture.getSize().height) ?? 1);
  }
  /**
   * Prepare the defines
   * @param defines
  ...
  dispose() {
    var _a;
    (_a = this.colorsTexture) == null ? void 0 : _a.dispose();
    super.dispose();
  }
  /**
  ...
  setColors(colors, lazy = false, forceNewTexture = false) {
    var _a, _b, _c;
    const origColorsCount = ((_a = this._colors) == null ? void 0 : _a.length) ?? 0;
    this._colors = colors;
    if (colors === null || colors.length === 0) {
      (_b = this.colorsTexture) == null ? void 0 : _b.dispose();
      return;
    }
    ...
    if (this.colorsTexture && origColorsCount === colors.length && !forceNewTexture) {
      ...
      (_c = this.colorsTexture) == null ? void 0 : _c.dispose();
  ...
  copyTo(plugin) {
    var _a;
    const dest = plugin;
    (_a = dest.colorsTexture) == null ? void 0 : _a.dispose();
    if (this._colors) {
...
var GreasedLineSimpleMaterial = class _GreasedLineSimpleMaterial extends ShaderMaterial {
  ...
  constructor(name, scene, options) {
    ...
    super(name, scene, {
      ...
      extraInitializationsAsync: async () => {
        if (isWGSL) {
          await Promise.all([import("./greasedLine.vertex-4XZVIELD.js"), import("./greasedLine.fragment-D4YXGZG5.js")]);
        } else {
          await Promise.all([import("./greasedLine.vertex-ERM23LVN.js"), import("./greasedLine.fragment-2ZZC67ZA.js")]);
        }
      },
  ...
  dispose() {
    var _a;
    (_a = this._colorsTexture) == null ? void 0 : _a.dispose();
    super.dispose();
  }
  ...
  setColors(colors, lazy = false, forceNewTexture = false) {
    ...
    this._colors = colors;
    if (colors === null || colors.length === 0) {
      (_b = this._colorsTexture) == null ? void 0 : _b.dispose();
      return;
    }
    if (lazy && !forceNewTexture) {
      return;
    ...
    if (this._colorsTexture && origColorsCount === colors.length && !forceNewTexture) {
      ...
      (_c = this._colorsTexture) == null ? void 0 : _c.dispose();
...
function PrepareAttributesForDraco(input, excludedAttributes) {
  ...
  for (const kind of input.getVerticesDataKinds()) {
    if (excludedAttributes == null ? void 0 : excludedAttributes.includes(kind)) {
      if (kind === VertexBuffer.PositionKind) {
...
var DracoEncoder = class _DracoEncoder extends DracoCodec {
  ...
  async encodeMeshAsync(input, options) {
    ...
    if (input instanceof Mesh && input.morphTargetManager && (options == null ? void 0 : options.method) === "MESH_EDGEBREAKER_ENCODING") {
    ...
    const attributes = PrepareAttributesForDraco(input, options == null ? void 0 : options.excludedAttributes);
...
var GreasedLineBaseMesh = class extends Mesh {
  ...
  updateLazy() {
    ...
    this._createVertexBuffers((_a = this._options.ribbonOptions) == null ? void 0 : _a.smoothShading);
    !this.doNotSyncBoundingInfo && this.refreshBoundingInfo();
    (_b = this.greasedLineMaterial) == null ? void 0 : _b.updateLazy();
  }
  /**
  ...
  set offsets(offsets) {
    if (this.material instanceof GreasedLineSimpleMaterial) {
      this.material.setDefine(GreasedLineUseOffsetsSimpleMaterialDefine, (offsets == null ? void 0 : offsets.length) > 0);
    }
  ...
  get greasedLineMaterial() {
    ...
    const materialPlugin = (_b = (_a = this.material) == null ? void 0 : _a.pluginManager) == null ? void 0 : _b.getPlugin(GreasedLinePluginMaterial.GREASED_LINE_MATERIAL_NAME);
    if (materialPlugin) {
  ...
  setPoints(points, options) {
    this._points = GreasedLineTools.ConvertPoints(points, (options == null ? void 0 : options.pointsOptions) ?? this._options.pointsOptions);
    this._updateWidths();
    if (!(options == null ? void 0 : options.colorPointers)) {
      this._updateColorPointers();
    }
...
//# sourceMappingURL=chunk-6YDJQFTH.js.map
