...
async function _CreateDumpRendererAsync() {
  if (!EnginePromise) {
    EnginePromise = new Promise((resolve, reject) => {
      ...
      import("./thinEngine-VHJCU2I6.js").then(({ ThinEngine: thinEngineClass }) => {
        var _a;
        ...
        import("./pass.fragment-YZARCOA3.js").then(({ passPixelShader }) => {
          if (!engine) {
...
//# sourceMappingURL=chunk-HQI47CTT.js.map
