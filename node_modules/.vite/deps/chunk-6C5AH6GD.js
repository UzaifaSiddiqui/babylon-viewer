...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRgbdTextureAsync = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGpu) {
        await import("./rgbdDecode.fragment-5F4K3GOQ.js");
      } else {
        await import("./rgbdDecode.fragment-HSMEBA7K.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-GNNX4PQN.js");
    } else {
      await import("./rgbdEncode.fragment-PTPMLAXU.js");
    }
...
//# sourceMappingURL=chunk-6C5AH6GD.js.map
